package com.bank.bian.knowyourcustomer.model;
...
/**
 * The BIAN control record for this service domain: "KYC Assessment Procedure".
 *
 ...
 * to its asset type (KYC Assessment). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "KYC Assessment Procedure";
